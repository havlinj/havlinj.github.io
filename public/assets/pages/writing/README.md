...
- **bg.jpg** – Background behind the individual article labels (buttons). Provide one image in this folder and adjust its processing in `src/pages/writing.astro` via `--page-button-bg-*` variables.
