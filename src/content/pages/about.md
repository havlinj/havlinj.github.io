...
Languages are tools. Architecture, clarity of thought and long-term maintainability are the constants.

I have built and maintained production systems where reliability, predictability and performance were non-negotiable. My approach is grounded in strong engineering fundamentals: system design, explicit trade-off analysis, test-driven thinking, and a bias toward solutions that remain understandable and evolvable years later.

While Rust has been a significant part of my professional journey, I am equally comfortable evaluating or working with other ecosystems when they better serve the architectural goals. My preference for Rust, Go and Elixir reflects experience — not limitation.
...
- Working on products that attempt something structurally new

That said, I am realistic: not every project is pioneering. In such cases, the deciding factor is depth of learning, technical challenge, and exposure to meaningful complexity.

I am a strong advocate of full remote or remote-first environments. I work well in distributed, international teams and operate comfortably with a high degree of autonomy. Occasionally, I combine this with light digital nomadism.